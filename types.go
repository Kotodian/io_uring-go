...
import (
	...
	iouring_syscall "github.com/Kotodian/iouring-go/syscall"
)
...
type SubmissionQueue struct {
	...
	dropped *uint32 // incremented for each invalid submission queue entry encountered in the ringbuffer
