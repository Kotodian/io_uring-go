...
const (
	...
	IOSQE_FLAGS_IO_ASYNC
	IOSQE_FLAGS_IO_BUFFER_SELECT
)
...
func (sqe *SubmissionQueueEntry) Opcode() uint8 { return sqe.opcode }

func (sqe *SubmissionQueueEntry) Reset() {
	*sqe = SubmissionQueueEntry{}
}

func (sqe *SubmissionQueueEntry) PreOperation(op uint8, fd int32, addrOrSpliceOFfIn uint64, len uint32, offset uint64) {
	sqe.opcode = op
	sqe.fd = fd
...
func (sqe *SubmissionQueueEntry) SetPersonality(personality uint16) {
